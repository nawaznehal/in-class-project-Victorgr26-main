...
function create() {
  ...
  //destructible platform group

  const destructiblePlatforms = this.physics.add.group({
    immovable: true,
    allowGravity: false,
  })

  //Adding destructible platforms
  destructiblePlatforms.create(250,400,"platform1");
  destructiblePlatforms.create(300,300,"platform1");
